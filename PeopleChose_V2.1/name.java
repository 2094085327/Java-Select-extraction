...
class Chose2 extends NameList {
    ...
    public void error() {
        System.out.println("——输入超出剩余人数——");
        System.out.print("请重新输入：");
        number = scanner.nextInt();
    }

    public void error2() {
        System.out.println("——男生输入超出剩余人数——");
        System.out.print("请重新输入：");
        number2 = scanner.nextInt();
    }

    public void error3() {
        System.out.println("——女生输入超出剩余人数——");
        System.out.print("请重新输入：");
    ...
    public void print_1(int number) {
        ...
        switch (num) {
            ...
            case 2 -> {
                // 选择具体数字的男女生进行抽取
                if (number2 > name_list1.size() && number3 < name_list2.size()) {
                    error2();
                    person();
                }
                if (number3 > name_list2.size() && number2 < name_list1.size()) {
                    error3();
                    person();
                }
                if (number2 > name_list1.size() && number3 > name_list2.size()) {
